...
public class UserService implements UserDetailsService {
    ...
    public ApiResponse updateUser( AppUser user) {
        AppUser user1 = new AppUser(user);
        userRepo.save(user1);
        ApiResponse apiResponse = new ApiResponse();
        apiResponse.setAppUser(user1);
        return apiResponse;
    }
    ...
    public ApiResponse getUser(String username) {
        ApiResponse apiResponse = new ApiResponse();
        apiResponse.setAppUser(userRepo.findByUsername(username).orElseThrow(()->new UsernameNotFoundException("User not found")));
        return apiResponse;
    }
